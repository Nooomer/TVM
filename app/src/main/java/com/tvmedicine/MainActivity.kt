...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!sPref.getString("login", "").isNullOrEmpty() and !sPref.getString("password", "")
                .isNullOrEmpty() and !sPref.getString("user_type", "").isNullOrEmpty()
        ) {
            val intent = Intent(
                applicationContext,
    ...
    fun patientAuthBtn(view: android.view.View) {
        ...
        mDialogBuilder
            ...
            .setPositiveButton(getString(R.string.login_btn)) { _: DialogInterface, _: Int ->
                ...
                mService2.auth(
                    "authUser.php",
                    userInput1.text.toString(),
                    userInput2.text.toString()
                )
