        ...
        mDialogBuilder
                ...
                .setPositiveButton(getString(R.string.login_btn)) { _: DialogInterface, _: Int ->
                    ...
                    mService.getPatient("getPatient.php")
                            ?.enqueue(object : Callback<List<getPatientModel?>?> {


                                override fun onResponse(
                                        call: Call<List<getPatientModel?>?>?,
                                        response: Response<List<getPatientModel?>?>?
                                ) {
                                ...
                                override fun onFailure(call: Call<List<getPatientModel?>?>?, t: Throwable?) {
